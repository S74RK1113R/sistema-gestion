        ...
        <form onSubmit={modifyItem}>
          <div className="fixed inset-0 flex items-center justify-center gap-5 overflow-auto">
            <div className="bg-zinc-100 p-6 rounded-lg shadow-xl shadow-black/50 grid grid-cols-2 gap-5 max-w-11/12 max-h-11/12 overflow-auto">
              <h2 className="text-xl font-bold col-span-2">Modificar Posgrado</h2>
              ...
              <div className="flex flex-col justify-center items-center w-full gap-2">
                ...
                <Input type="number" inputName="año" defaultValue={año} ref={newAnioRef} />
              </div>

              <div className="flex flex-col justify-center items-center w-full gap-2">
                <label htmlFor="cantidad">Cantidad:</label>
                <Input type="number" inputName="cantidad" defaultValue={cantidad} ref={newCantidadRef} />
              </div>

              <button type="submit" className="bg-blue-500 row-start-4 text-white px-4 py-2 rounded hover:bg-blue-600">Guardar Cambios</button>
              <button type="button" className="bg-zinc-500 row-start-4 text-white px-4 py-2 mx-5 rounded hover:bg-red-600" onClick={() => setShowModal(false)}>Cancelar</button>
            </div>
          </div>
        </form>
      )}
