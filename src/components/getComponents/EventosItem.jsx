export default function EventosItem({año, titulo, nombre_evento, clasificacion, profesor_id, profesor_autor_id2,profesor_autor_id3,profesor_autor_id4,profesor_autor_id5,id }) {
    return(
