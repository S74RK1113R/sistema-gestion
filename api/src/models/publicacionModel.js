...
class Publicaciones {
    ...
    postPublicacion(anio, titulo, revistaEditorial, isbnIssn, clasificacion, bd_revista, autor_profesor_id, coautor_id, coautor_id_2, coautor_id_3, grupo, callback) {
        const sql = 'INSERT INTO publicacion (`año`, titulo, `revista/editorial`, `isbn/issn`, clasificacion, bd_revista, autor_profesor_id, coautor_id, coautor_id_2, coautor_id_3, grupo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
    ...
    putPublicacion(id, anio, titulo, revistaEditorial, isbnIssn, clasificacion, bd_revista, autor_profesor_id, coautor_id, coautor_id_2, coautor_id_3, grupo, callback) {
        const sql = 'UPDATE publicacion SET `año`=?, titulo=?, `revista/editorial`=?, `isbn/issn`=?, clasificacion=?, bd_revista=?, autor_profesor_id=?, coautor_id=?, coautor_id_2=?, coautor_id_3=?, grupo=? WHERE id=?';
