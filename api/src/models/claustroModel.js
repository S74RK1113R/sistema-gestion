...
class Claustros {
    ...
    postClaustros(total_claustro, drc, drc_equivalentes, drc_afin, mc_equivalentes, pt_pa, anio_evaluacion, callback) {
        const sql = 'INSERT INTO claustro (`total_claustro`, `dr.c`, `dr.c/equivalentes`, `dr.c/afin`, `mc/equivalentes`, `pt/pa`, `año_evaluacion`) VALUES (?, ?, ?, ?, ?, ?, ?)';
    ...
    putClaustros(id, total_claustro, drc, drc_equivalentes, drc_afin, mc_equivalentes, pt_pa, anio_evaluacion, callback) {
        const sql = 'UPDATE claustro SET `total_claustro`=?, `dr.c`=?, `dr.c/equivalentes`=?, `dr.c/afin`=?, `mc/equivalentes`=?, `pt/pa`=?, `año_evaluacion`=? WHERE id=?';
